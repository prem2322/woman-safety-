...
public class DatabaseHelper extends SQLiteOpenHelper
{
   ...
   // private static final String TABLE_SAFETY_ALERTS = "alert_control";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_USERS_LOGIN_TABLE = "CREATE TABLE " + USERS_LOGIN + " (user_id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT, password TEXT)";
        db.execSQL(CREATE_USERS_LOGIN_TABLE);

        // Create users_signup table
        String CREATE_USERS_SIGNUP_TABLE = "CREATE TABLE " + USERS_SIGNUP + " (user_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, email TEXT, password TEXT)";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + USERS_LOGIN);
        db.execSQL("DROP TABLE IF EXISTS " + USERS_SIGNUP);
    ...
    public boolean insertUserData(String name, String email, String password) {
        ...
        long result = db.insert("users_signup", null, contentValues);
    ...
    public static boolean checkLogin(SQLiteDatabase db,String email, String password) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM users_signup WHERE email = ? AND password = ?", new String[]{email, password});
